...
def polyw1_pack(r, index, a): 

	if (GAMMA2 == (Q-1)//88):
		for i in range(N >> 2):
			r[index + 3*i+0]  = (a.coeffs[4*i+0])%256;
			r[index + 3*i+0] |= (a.coeffs[4*i+1] << 6)%256
			r[index + 3*i+1]  = (a.coeffs[4*i+1] >> 2)%256
			r[index + 3*i+1] |= (a.coeffs[4*i+2] << 4)%256
			r[index + 3*i+2]  = (a.coeffs[4*i+2] >> 4)%256
			r[index + 3*i+2] |= (a.coeffs[4*i+3] << 2)%256
	elif (GAMMA2 == (Q-1)//32):
		for i in range(N >> 1):
...
def poly_print(v):
	...
	print("[", end='')
	print(v.coeffs[0], end='')
	for i in range(1,N):
		print(", ", v.coeffs[i], end='')
	print("]", end='')